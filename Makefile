...
// --- Feature Test Macros ---
// These must be defined BEFORE any standard headers are included
// to enable POSIX/SUSv4 functions like kill(), stat(), standard IPC, etc.
// when using strict language standards like -std=c99.
#define _GNU_SOURCE
...
#include <sys/stat.h>   // for stat, mkfifo, S_ISDIR, etc.
