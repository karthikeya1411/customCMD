...
// --- Feature Test Macros ---
// These MUST be at the very top, before ANY includes,
// to enable POSIX functions (like sigprocmask, kill, etc.)
// when compiling with strict standards (e.g., -std=c99).
#define _GNU_SOURCE
...
#define MAX_CONCURRENT_JOBS 5  // Max jobs the server will run at once
...
#define STATUS_KILLED 5     // Job was killed by user
 ...
 * This is an inline function to be included in any file that
 * needs to lock the semaphore. It will block until available.
 */
